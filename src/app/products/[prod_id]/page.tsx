        ...
        <>
            <div className="grid w-full grid-cols-1 items-center gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8 mt-6">
                ...
                <div className="sm:col-span-8 lg:col-span-7">
                    ...
                    <span className='inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10 mt-1'>{products[0].cat_name}</span>
                    <section aria-labelledby="information-heading" className="mt-2">
                        <p className="text-xl font-semibold text-gray-900">Rs. {products[0].prod_price}</p>
                    ...
                    <section aria-labelledby="options-heading" className="mt-4">
                        <form>
                            <div>
                                <h4 className="text-sm font-bold text-gray-900">SELECT COLOR</h4>
                            ...
                            <div className='mt-2'>
                                <Quantity minQuantity={products[0].prod_stock} />
                            </div>
