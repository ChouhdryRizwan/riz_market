...
export default function Quantity({ minQuantity }: IQty) {
    ...
    return (
        <div className="flex lg:flex-row xl:flex-row flex-col gap-x-6 lg:items-center xl:items-center mt-4">
            <h2 className="text-sm font-bold text-gray-900 mb-4 lg:mb-0 xl:mb-0">QUANTITY: </h2>
            <div className="space-x-3">
                <span className="bg-gray-200 px-3 py-2 font-bold rounded-full cursor-pointer" onClick={() => dec()}> -</span> 
                <span className="border-b-2 border-gray-200 px-4">{currentQuatity}</span>
